  ...
  return (
    <div className="bg-gray-100">
      <div className="max-w-screen-2xl container py-12 xl:px-12 px-4 pb-12">
        <p className="title font-Protest">
        ...
        <div className="flex flex-col mt-3 md:gap-10 justify-center items-center gap-5">
          <p className="title font-Protest">Or Subscribe to the newsletter</p>
          <div className="flex flex-col w-full md:flex-row gap-5 md:w-[40%]">
            ...
            />
            <button className="py-3 bg-black sm:bg-transparent sm:border-b-2 text-sm px-3 sm:border-gray-400 font-bold transition duration-300 text-white sm:hover:border-black sm:hover:text-black inline-block uppercase sm:text-gray-500">
              Submit
            </button>
          </div>
        </div>
